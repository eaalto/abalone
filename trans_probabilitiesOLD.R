...
################################################################
#load("/Users/marisarossetto/Desktop/demographic_model/crescita/fitting_crescita/fits")
...
for(i in 1:(length(limits)-1))
{
	...
	pgamma(k(limits[i+1]-l1,l1)-l1,rate=lambda(l1),shape=ro(l1))-pgamma(k(limits[i]-l1,l1)-l1,rate=lambda(l1),shape=ro(l1))};
...
#save(p,limits,file="/Users/marisarossetto/Desktop/demographic_model/crescita/fitting_crescita/trans_prob")